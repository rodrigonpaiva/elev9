...
export interface CoachDecisionSourceContext {
    ...
    habitRiskSignals?: Array<'inactivity_pattern' | 'streak_at_risk' | 'declining_consistency' | 'dropout_risk'>;
    generatedAt: string;
}
