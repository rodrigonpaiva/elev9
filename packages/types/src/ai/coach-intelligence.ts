...
export type CoachIntelligenceSectionName =
  | 'insight'
  | 'evidence'
  | 'explainability'
  | 'training'
...
export type CoachIntelligenceAvailabilityStatus =
  | 'available'
  | 'unavailable'
  | 'stale'
  | 'degraded'
...
export type CoachIntelligenceAvailabilityReasonCode =
  | 'READY'
  | 'MISSING_CONTEXT'
  | 'STALE_CONTEXT'
  | 'SOURCE_UNAVAILABLE'
...
export type CoachIntelligenceWarningSeverity =
  | 'LOW'
  | 'MEDIUM'
  | 'HIGH'
  | 'CRITICAL';

export type CoachIntelligenceWarningCode =
  | 'MISSING_CONTEXT'
  | 'STALE_CONTEXT'
  | 'PARTIAL_RESPONSE'
  | 'FEATURE_DISABLED'
