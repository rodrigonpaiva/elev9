...
export type AdaptiveRecommendationType = 'increase_intensity' | 'decrease_intensity' | 'increase_volume' | 'decrease_volume' | 'recovery_workout' | 'rest_day' | 'reschedule_workout' | 'maintain';
export type AdaptiveRecommendedIntensity = 'recovery' | 'light' | 'moderate' | 'hard';
export type AdaptiveVolumeAction = 'increase' | 'maintain' | 'decrease';
export type AdaptiveTrainingInfluenceCode = 'HIGH_READINESS' | 'LOW_READINESS' | 'HIGH_FATIGUE' | 'LOW_FATIGUE' | 'RECOVERY_TREND_IMPROVING' | 'RECOVERY_TREND_DECLINING' | 'HIGH_ADHERENCE' | 'LOW_ADHERENCE' | 'LONG_STREAK' | 'MISSED_WORKOUTS' | 'GOOD_NUTRITION_SUPPORT' | 'POOR_NUTRITION_SUPPORT' | 'RECENT_WORKOUT_LOAD_HIGH' | 'RECENT_WORKOUT_LOAD_LOW';
