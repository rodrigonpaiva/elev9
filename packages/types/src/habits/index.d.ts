export type HabitType = 'workout' | 'recovery' | 'nutrition' | 'check_in' | 'coaching';
...
export type RiskSignalType = 'inactivity_pattern' | 'streak_at_risk' | 'declining_consistency' | 'dropout_risk';
...
export interface HabitReplayDifference {
    field: 'consistencyScore' | 'streakDays' | 'adherenceScore' | 'trend' | 'formulaVersion';
    persisted: unknown;
