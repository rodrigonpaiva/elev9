export type CoachingStyle = 'motivational' | 'direct' | 'educational' | 'balanced';
export type EngagementProfile = 'low' | 'medium' | 'high';
export type ResponsivenessLevel = 'low' | 'medium' | 'high';
export type BehavioralPatternType = 'responds_to_streaks' | 'responds_to_goals' | 'responds_to_recovery_guidance' | 'responds_to_notifications' | 'ignores_low_priority_reminders' | 'morning_engagement' | 'evening_engagement' | 'high_dismissal_behavior' | 'consistent_check_in_behavior';
...
export type PersonalizationReplayComparisonField = 'preferredCoachingStyle' | 'engagementProfile' | 'notificationResponsiveness' | 'goalResponsiveness' | 'recoveryResponsiveness' | 'habitResponsiveness' | 'riskOfDisengagement' | 'trend' | 'formulaVersion';
