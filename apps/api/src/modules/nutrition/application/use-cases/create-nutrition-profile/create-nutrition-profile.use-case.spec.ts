...
describe("CreateNutritionProfileUseCase", () => {
  ...
  it("creates a nutrition profile successfully", async () => {
    ...
    expect(nutritionProfileRepository.upsertByUserProfileId).toHaveBeenCalledWith({
      userProfileId: "profile_123",
      goal: "muscle_gain",
      mealsPerDay: 4,
      dietaryRestrictions: [],
  ...
  it("fails when the user profile does not exist", async () => {
    ...
    expect(nutritionProfileRepository.upsertByUserProfileId).not.toHaveBeenCalled();
  });
