...
export const recoveryHistoryFixture: RecoveryExperienceHistoryItem[] = [
  { localDate: '2026-07-22', score: 64, category: 'moderate', availability: 'available', freshness: 'current' },
  { localDate: '2026-07-23', score: 70, category: 'good', availability: 'available', freshness: 'current' },
  { localDate: '2026-07-24', score: 74, category: 'good', availability: 'available', freshness: 'current' },
  { localDate: '2026-07-25', score: 78, category: 'good', availability: 'available', freshness: 'current' },
];
...
export const availableRecoveryFixture = {
  ...
  recovery: {
    ...
    trend: 'improving',
    breakdown: [
      { key: 'energy', impact: 'positive', labelKey: 'recovery.factors.energy.label', explanationKey: 'recovery.factors.energy.positive' },
      { key: 'sleep', impact: 'neutral', labelKey: 'recovery.factors.sleep.label', explanationKey: 'recovery.factors.sleep.neutral' },
      { key: 'muscle_soreness', impact: 'negative', labelKey: 'recovery.factors.soreness.label', explanationKey: 'recovery.factors.soreness.negative' },
    ],
    insight: {
      tone: 'positive',
...
export const unknownFreshnessRecoveryScreenFixture: RecoveryScreenAvailableState = {
  ...availableRecoveryScreenFixture,
  current: { ...availableRecoveryScreenFixture.current, freshness: 'unknown' },
};
