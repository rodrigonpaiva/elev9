# Implementation Matrix — Elev9 Coach
...
- The coach experience is built from existing read models and shared contracts.
- The mobile app is the primary product surface today.
- The web app remains a minimal workspace surface and is not the main user experience.
